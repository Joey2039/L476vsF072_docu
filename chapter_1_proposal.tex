...
communication.
These systems are increasingly interconnected, over internal buses such as CAN,
LIN, and Automotive Ethernet and external interfaces such as V2X and telematics,
which increases the attack surface exposed to adversaries.
...
ECUs span a wide spectrum of computational capability, from high-end domain
controllers with multi-core processors and dedicated cryptographic co-processors
down to simple body control modules, sensor nodes, and actuator controllers
built around low-cost 32-bit microcontrollers with RAM measured in tens of
kilobytes and no hardware cryptographic accelerator.
On these constrained devices the computational cost of cryptographic operations
...
The resulting standard was published in August 2025 as NIST SP~800-232~\cite{NISTSP800232}.
